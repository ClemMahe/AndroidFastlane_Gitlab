...
RUN dpkg --add-architecture i386 && \
  ...
  echo "no" | avdmanager create avd --name "Test-Emulator-API23-Nexus-5-0" --package "ssystem-images;android-25;google_apis;x86" --device "Nexus 5X" --tag "google_apis" --abi "x86"  && \
